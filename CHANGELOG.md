...
This file was started on 2026-08-31. 2 versions were released before it, the most recent
`v0.2.0`, and neither is written up here: the record of that history is `git log` and the
