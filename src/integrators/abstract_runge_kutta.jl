...
AbstractStochasticIntegratorRK{DT, TT, D, M, S} = Union{
    StochasticIntegratorRK{DT, TT, D, M, S}, StochasticIntegratorPRK{DT, TT, D, M, S}}
...
@inline nstages(::AbstractStochasticIntegratorRK{
    DT, TT, D, M, S}) where {DT, TT, D, M, S} = S
@inline noisedims(::AbstractStochasticIntegratorRK{
    DT, TT, D, M, S}) where {DT, TT, D, M, S} = M
@inline Base.ndims(::AbstractStochasticIntegratorRK{
    DT, TT, D, M, S}) where {DT, TT, D, M, S} = D
